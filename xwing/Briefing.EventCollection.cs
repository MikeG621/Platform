...
namespace Idmr.Platform.Xwing
{
	public partial class Briefing
	{
		...
		public new class EventCollection : ResizableCollection<Event>
		{
			...
			readonly internal int _maxEvents = EventQuantityLimit;
			readonly int _ticksPerSecond = TicksPerSecond;
			...
			public EventCollection(byte[] raw)
			{
		...
		public new class Event
		{
			...
			/// <summary>Returns <b>true</b> if <see cref="Type"/> is within <see cref="EventType.FGTag1"/> and <see cref="EventType.FGTag4"/>.</summary>
			public bool IsFGTag => (int)_type >= (int)EventType.FGTag1 && (int)_type <= (int)EventType.FGTag4;
			/// <summary>Returns <b>true</b> if <see cref="Type"/> is within <see cref="EventType.TextTag1"/> and <see cref="EventType.TextTag4"/>.</summary>
			public bool IsTextTag => (int)_type >= (int)EventType.TextTag1 && (int)_type <= (int)EventType.TextTag4;
