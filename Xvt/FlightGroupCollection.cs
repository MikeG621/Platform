...
namespace Idmr.Platform.Xvt
{
	...
	/// <remarks><see cref="Idmr.Common.ResizableCollection{T}.ItemLimit"/> is set to <see cref="Mission.FlightGroupLimit"/> (46)</remarks>
	public class FlightGroupCollection : Idmr.Common.ResizableCollection<FlightGroup>
	{
		...
		/// <exception cref="ArgumentOutOfRangeException"><i>quantity</i> is less than 1 or greater than <see cref="Idmr.Common.ResizableCollection{T}.ItemLimit"/></exception>
		...
		/// <returns>An array of short-form string representations</returns>
